...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleHttpMessageNotReadable(HttpMessageNotReadableException ex,
        ...
        String detail = "O corpo da requisição está inválido. Vefifique erro de sintaxe";
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(MSG_ERRO_GENERICA_USUARIO_FINAL)
                .build();
    ...
    private ResponseEntity<Object> handlePropertyBindingException(PropertyBindingException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        if(ex instanceof IgnoredPropertyException){
            problemType = ProblemType.PROPRIEDADE_INEXISTENTE;
            ...
            problemType = ProblemType.PROPRIEDADE_DESCONHECIDA;
            detail = String.format("A propriedade '%s' não faz parte do domínio", path);
        }
        Problem problem = createProblemBuilder(status, problemType, detail)
                .userMessage(MSG_ERRO_GENERICA_USUARIO_FINAL)
                .build();
